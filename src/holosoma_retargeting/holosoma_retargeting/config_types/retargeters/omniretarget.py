"""Configuration for the OmniRetarget method (Interaction Mesh / SQP).

This is the original retargeting algorithm of holosoma_retargeting.
...
@dataclass(frozen=True)
class OmniRetargeterConfig:
    """Configuration for OmniRetarget (Interaction Mesh + SQP).

    These parameters control the SQP-based retargeting optimization.
    Can be overridden via CLI with --retargeter.<param>.
    """
