...
g1_29dof_wbt_randomization_isaacsim = RandomizationManagerCfg(
    setup_terms={**base_setup_terms},
    reset_terms={**base_reset_terms},
    step_terms={**base_step_terms},
)

g1_29dof_wbt_randomization_isaacsim_w_object = RandomizationManagerCfg(
    setup_terms={
        **base_setup_terms,
        **object_state_dr_at_setup,
    },
...
__all__ = [
    "g1_29dof_wbt_randomization_isaacsim",
    "g1_29dof_wbt_randomization_isaacsim_w_object",
    "g1_29dof_wbt_randomization_mjwarp",
    "g1_29dof_wbt_randomization_mjwarp_w_object",
]
